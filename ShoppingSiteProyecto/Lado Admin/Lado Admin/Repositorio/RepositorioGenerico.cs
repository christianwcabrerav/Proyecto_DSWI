...
{
    public class RepositorioGenerico<Tbl_Entity> : IRepositorio<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;

        private dbMyOnlineShoppingEntities _DBEntity;

        public RepositorioGenerico(dbMyOnlineShoppingEntities DBEntity)
        {
            _DBEntity = DBEntity;
